    ...
    await batch_db(
        ...
        (
            functools.partial(
                ...
                team_bpg=float_safe(team.defensive_stats.blk.total if team.defensive_stats else None),
                team_spg=float_safe(team.defensive_stats.stl.total if team.defensive_stats else None),
                team_apg=float_safe(team.offensive_stats.ast.total if team.offensive_stats else None),
                team_fga=float_safe(team.offensive_stats.fga.total if team.offensive_stats else None),
                team_fgm=float_safe(team.offensive_stats.fgm.total if team.offensive_stats else None),
                team_fta=float_safe(team.offensive_stats.fta.total if team.offensive_stats else None),
                team_tov=float_safe(team.defensive_stats.tov.total if team.defensive_stats else None),
            )
            for team in teams
        ),
    )
